...
# the DTU dataset preprocessed by Ding Yikang (Self-supervised training using checked peudo-depth)
class MVSDataset(Dataset):
    def __init__(self, datapath, listfile, mode, nviews=5, ndepths=192, interval_scale=1.06, **kwargs):
    ...
    def __getitem__(self, idx):
        ...
        #all
        imgs = np.stack(imgs).transpose([0, 3, 1, 2])   # N,3,h,w
        #ms proj_mats
