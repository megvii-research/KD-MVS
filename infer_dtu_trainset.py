...
parser.add_argument('--pcdpath', help='path for saving pcd results')
...
def save_scene_depth(testlist):
    ...
    # model
    model = CascadeMVSNet_uncertainty(refine=False, ndepths=[int(nd) for nd in args.ndepths.split(",") if nd],
...
if __name__ == '__main__':
    ...
    # # # step 2. filter saved depth maps with photometric confidence maps and geometric constraints
